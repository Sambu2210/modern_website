...
const Hero = () => {
 return(
    <section id='home' className={`${styles.paddingY} flex md:flex-row flex-col`}>
      <div className={`flex flex-1 ${styles.flexStart} flex-col xl:p-0 sm:px-16 px-6`}>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className='absolute z-[1] w-[80%] h-[30%] rounded-full bottom-40 white__gradient'></div>
        <div className='absolute z-[0] w-[50%] h-[50%] bottom-0 blue__gradient'></div>
      </div>
